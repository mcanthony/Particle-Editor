        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', function( $scope ) {
                    ...
                    $scope.rightClickNode = function(node){
                      alert("Hello World");
                    };
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<div class="tree-label '+classIfDefined($scope.options.injectClasses.label, false)+'" ng-class="selectedClass()" ng-right-click="rightClickNode(node)" ng-click="selectNodeLabel(node)" tree-transclude></div>' +
